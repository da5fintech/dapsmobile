...
const BILLS_PAYMENT_TRANSPORTATION_AUTOSWEEP_TITLE = "All Billers (Transportation)";
const BILLS_PAYMENT_TRANSPORTATION_AUTOSWEEP_TEXT = "Autosweep";
const BILLS_PAYMENT_TRANSPORTATION_POSTED_IMMEDIATELY = "Payment will be posted immediately";
...
const PAYMENT_PROCESSING_INVALID_INPUT_TEXT = "You have entered an incorrect\nMPIN. Please try again,";
